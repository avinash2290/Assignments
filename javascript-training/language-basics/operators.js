...
//There are 5 different types of operators in JavaScript.
...
// * Multiplication.
// / Division
// % Modulus (Returns the remainder of division operations.) (9 % 3 = 0), (5%2 = 1)
...
//If ++ /-- is written on the right side of the variable (a++, b--), It will be treated as post increment or decrement.
console.log(a++);
console.log(b--);
console.log(a);
console.log(b);
...
//If ++ /-- is written on the left side of the variable (++c, --d), It will be treated as pre increment or decrement.
console.log(++c);
console.log(--d);
